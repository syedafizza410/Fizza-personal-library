...
lottie_book = load_lottieurl("https://assets9.lottiefiles.com/packages/lf20_47pyyfcj.json")
if lottie_book:
    with st.sidebar:
...
st.markdown("...")
st.markdown("Copyright @ 2025 UmmeFizza Personal Library System", unsafe_allow_html=True)